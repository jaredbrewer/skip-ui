...
| 2 | fix/ignores-safe-area-constraint-overflow | PR_DRAFT_2c.md | Production crash trace + arithmetic-proof regression test; honestly framed as defensive hardening (Robolectric cannot produce nonzero insets; app-scale-only trigger stated); FTL: 0 crashes on both One UI and AOSP at stock (4/4 pass, Board Setup sheet included) |
